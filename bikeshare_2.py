...
def get_filters():
    ...
    """city name input -ocinci"""
  
    while True:
      city=input("Please enter one city name between:chicago, new york city, washington\n").lower()
    ...
    while True:      
        month=input("Please enter one month:january,february,march,april,may,june or all\n").lower()
    ...
    """day name input -ocinci"""
    
    while True:
        day=input("Please enter one day of week or enter 'all'\n").lower()
...
def raw_data(df):
    ...
    k=0
    s=input("Do you want to see raw data? If you want write 'yes', if you do not want write 'no\n'").lower()
    if s=='yes':              
        ...
        while s =='yes':
           ...
           print(df.iloc[:k]) 
           s=input("Do you want to see 5 more data? If you want write 'yes', if you do not want write 'no\n'").lower()
           continue
